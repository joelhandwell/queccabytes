...
/**
ref1: https://stackoverflow.com/questions/3758606/how-can-i-convert-byte-size-into-a-human-readable-format-in-java
ref2: ronna quecca from https://www.science.org/content/article/you-know-kilo-mega-and-giga-metric-system-ready-ronna-and-quecca
 */
fun humanReadableByteCount(bytes: BigDecimal, si: Boolean = true): String? {
    ...
    var result = bytes
    val unitsToUse =
        (if (si) "k" else "K") + "MGTPEZYRQXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" +
...
fun main() {
    File("out.txt").printWriter().use { out ->
        (1..10000).forEach {
            ...
            val toPrint = "2 ^ %3d = %9s = $number".format(power, withPrefix)
            println(toPrint)
            out.println(toPrint)
        }
    }
